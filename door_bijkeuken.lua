...
return {
	...
	execute = function(domoticz, device)
		...
		if tonumber(domoticz.globalData.door_bijkeuken_message_interval) >  (message_interval_minutes/script_interval_minutes) then
			domoticz.globalData.door_bijkeuken_message_interval = 0
		end
