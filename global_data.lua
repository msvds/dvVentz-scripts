return {
	...
	data = {
		OpenCEetkamerdeur = { initial = 0 },
		ClosedCEetkamerdeur = { initial = 0 },
		...
		ClosedCBalkondeurNienke = { initial = 0 },
		OpenCSlaapkdeur = { initial = 0 },
		ClosedCSlaapkdeur = { initial = 0 },
		OpenCDakraamzolder = { initial = 0 },
		ClosedCDakraamzolder = { initial = 0 },
		OpenCDeurbijkeuken = { initial = 0 },
		ClosedCDeurbijkeuken = { initial = 0 },
		OpenCDeurgarage = { initial = 0 },
		ClosedCDeurgarage = { initial = 0 },
