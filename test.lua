return {
	...
	execute = function(domoticz, device)
		...
		domoticz.log('Huidige currentTemperature is '.. currentTemperature)
		currentProgramState = domoticz.helpers.currentProgramState(domoticz)
		domoticz.log('Huidige currentTemperature is '.. currentProgramState)
		currentActiveState = domoticz.helpers.currentActiveState(domoticz)
		domoticz.log('Huidige currentTemperature is '.. currentActiveState)
		currentNextTime = domoticz.helpers.currentNextTime(domoticz)
		domoticz.log('Huidige currentTemperature is '.. currentNextTime)
		currentNextSetPoint = domoticz.helpers.currentNextSetPoint(domoticz)
		domoticz.log('Huidige currentTemperature is '.. currentNextSetPoint)
