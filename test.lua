return {
	...
	execute = function(domoticz, device)
		...
		domoticz.log('Huidige currentProgramState is '.. currentProgramState)
		currentActiveState = domoticz.helpers.currentActiveState(domoticz)
		domoticz.log('Huidige currentActiveState is '.. currentActiveState)
		currentNextTime = domoticz.helpers.currentNextTime(domoticz)
		domoticz.log('Huidige currentNextTime is '.. currentNextTime)
		currentNextSetPoint = domoticz.helpers.currentNextSetPoint(domoticz)
		domoticz.log('Huidige currentNextSetPoint is '.. currentNextSetPoint)
