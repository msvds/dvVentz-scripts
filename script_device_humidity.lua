...
return {
	...
	execute = function(domoticz, device)
        ...
        local MessageInterval = 3600 --Interval of sending email notifications
        local lastMessageSent = uservariables["HumidityMessage"] --Time in system seconds when last message was sent
        local hum_string
